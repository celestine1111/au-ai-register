...
const ORIGIN = {
  ...
  Pakistan: {
    ...
    note: "BEOE returns HTTP 403 to automated requests including with a browser user agent, so its country-wise tables could not be tested. Pakistan Bureau of Statistics is reachable with no API found. BEOE regulates overseas EMPLOYMENT, which is Gulf-dominated.",
  },
  Bangladesh: {
    agency: "BMET / Bureau of Manpower Employment and Training",
    api: "no",
    api_url: "https://www.oep.gov.bd/reports/country-clearance",
    emigration_published: "yes (not via API)",
    australia_bound: "no",
    note: "The country-clearance report lists Australia as a selectable country but returns no rows for it. BMET's own site does not mention Australia. The system tracks overseas employment clearances, which are overwhelmingly Gulf-bound.",
  },
  Nepal: {
    ...
    emigration_published: "yes (not via API)",
    australia_bound: "no",
    note: "Publishes labour permits by destination. Top destinations are UAE, Malaysia, Qatar, Saudi Arabia and Kuwait; Australia does not appear. Nepalis coming to Australia arrive predominantly as students, and a student visa is not a labour permit. Reports are PDFs in Nepali.",
  },
  "Sri Lanka": { agency: "Department of Census and Statistics", api: "no", api_url: "http://www.statistics.gov.lk/", emigration_published: "not verified", australia_bound: "not verified", note: "Site reachable, no machine-readable API found at the tested endpoint." },
